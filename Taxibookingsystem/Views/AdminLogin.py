...
from Controllers.AdminManagement import loginadmin
...
class AdminLoginForm():
    def __init__(self, root):
        ...
        # Username
        self.username_lbl = Label(self.lgn_frame, text='Username', bg='#040405', fg='#4f4e4d',
                                  font=('times', 13, 'bold'))
        ...
        # password
        self.password_lbl = Label(self.lgn_frame, text='Password', bg='#040405', fg='#4f4e4d',
                                  font=('times', 13, 'bold'))
        ...
        self.login = Button(self.lgn_button_label, text='LOGIN', font=("times", 13, "bold"), width=25, bd=0,
    ...
    def Adminlogin(self):
        ...
        admin = Customer(username=username, password=password)
        admin_login = loginadmin(admin)

        if admin is not None:
            Global.admin_information =admin_login
            messagebox.showinfo("Welcome", "Welcome")
            from AdminDashboard import ADashboard
            self.root.destroy()
            new_window = Tk()
            ADashboard(new_window)
            new_window.mainloop()
        else:
