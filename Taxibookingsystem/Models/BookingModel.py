class Booking:
    def __init__(self, booking_id=0, pickup_address=None, dropoff_address=None, pickup_date=None, pickup_time=None, booking_status=None, customer_id=None, driver_id=None, admin_id=None):
